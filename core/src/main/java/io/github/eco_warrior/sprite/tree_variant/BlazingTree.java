...
//        int growingFrameCount = atlas.findRegions("growing_phase").size;
    ...
    protected void loadAudio() throws RuntimeException {
        this.growthSound = Gdx.audio.newSound(Gdx.files.internal("sound_effects/fireball.mp3"));
        ...
        this.digSound = Gdx.audio.newSound(Gdx.files.internal("sound_effects/Gravel_dig1.mp3"));
    }
