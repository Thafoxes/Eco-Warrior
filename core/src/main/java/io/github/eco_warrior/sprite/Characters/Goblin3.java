...
public class Goblin3 extends GameCharacter {
    ...
    public Goblin3(Vector2 position, int tileWidth, int tileHeight, TiledMapTileLayer collisionLayer, MapObjects objects) {
        super();
     ...
     * @param tileHeight
     */
    public Goblin3(Vector2 position, int tileWidth, int tileHeight, boolean isNPC) {
        this(position, tileWidth, tileHeight);
        this.texture = new Texture("character/goblin3/Goblin3.png");
        if(isNPC){
            this.isNPC = true;
        }
     ...
     * @param tileHeight
     */
    public Goblin3(Vector2 position, int tileWidth, int tileHeight) {
        super();
        this.position = position;
        this.oldPosition = new Vector2(position);
        this.velocity = new Vector2(0, 0);
    ...
    private void loadAnimations() {
        goblinsAtlas = new TextureAtlas("character/goblin3/Goblin3.atlas");
