...
public class VoltaicTree extends Trees {
    ...
    public VoltaicTree(Vector2 position, float scale) {
        super("atlas/tree_variant_stages/VoltaicTree.atlas",
            "flag",
            1,
            position,
            scale,
...
//        int growingFrameCount = atlas.findRegions("young_tree").size;
    ...
    protected void loadAudio() throws RuntimeException {
        this.growthSound = Gdx.audio.newSound(Gdx.files.internal("sound_effects/thunder.mp3"));
