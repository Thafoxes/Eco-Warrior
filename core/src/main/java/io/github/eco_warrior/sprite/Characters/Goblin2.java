...
public class Goblin2 extends GameCharacter {
    ...
    public Goblin2(Vector2 position, int tileWidth, int tileHeight, TiledMapTileLayer collisionLayer, MapObjects objects) {
        super();
     ...
     * @param tileHeight
     */
    public Goblin2(Vector2 position, int tileWidth, int tileHeight, boolean isNPC) {
        this(position, tileWidth, tileHeight);
        this.texture = new Texture("character/goblin2/Goblin2.png");
        if(isNPC){
            this.isNPC = true;
        }
     ...
     * @param tileHeight
     */
    public Goblin2(Vector2 position, int tileWidth, int tileHeight) {
        super();
        this.position = position;
        this.oldPosition = new Vector2(position);
        this.velocity = new Vector2(0, 0);
    ...
    private void loadAnimations() {
        goblinsAtlas = new TextureAtlas("character/goblin2/Goblin2.atlas");
