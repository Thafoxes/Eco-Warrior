...
public class TentaclesPool extends EnemyPool<TentaclesController>{

    public TentaclesPool(EnemyManager manager) {
        super(manager);
    ...
    @Override
    protected TentaclesController createEnemy(Vector2 vector2){
        return new TentaclesController(vector2);
    }
}
