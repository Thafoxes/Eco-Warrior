...
set CLASSPATH=%APP_HOME%\lib\EcoWarrior-1.0.0.jar


@rem Execute lwjgl3
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %LWJGL3_OPTS%  -classpath "%CLASSPATH%" io.github.eco_warrior.lwjgl3.Lwjgl3Launcher %*
